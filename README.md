...
Программа **Браконьеры** — это интересный и полезный инструмент для изучения работы алгоритмов поиска пути, а также демонстрация возможностей C++ для создания интерактивных консольных приложений.
